...
public class Main : MonoBehaviour {
	...
	private float springLength = 3.0f;
	...
	void Update () {
		...
		DrawLine(new Vector2(ball0.transform.position.x, ball0.transform.position.y), new Vector2(ball1.transform.position.x, ball1.transform.position.y));
	}
